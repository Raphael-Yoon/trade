    ...
    try:
        ...
        **주의**: 
        ...
        1. **종합 추천 의견 (Top 5 Picks)**:
           - 제공된 **재무 데이터**와 더불어, **분석 시점(현재) 기준으로 시장을 주도하고 있는 핵심 섹터 및 테마**와 산업 트렌드를 종합적으로 고려하여 가장 유망한 종목 5개를 선정해줘.
        ...
        **작성 가이드라인:**
        - **제목 설정**: 리포트의 메인 제목(#)은 '주식 시장 분석 및 Top 5 추천 종목 (YYYY.MM.DD)' 형식으로 간결하게 작성해줘. 과장되거나 너무 긴 제목은 피해서 작성해줘.
